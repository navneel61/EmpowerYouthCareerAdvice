...
public class CareerAdviceSummaryFragment extends Fragment {
    ...
    private final String[] mainContent = {"30 Resume Tips to Help You Get Hired - Advice from a fortune 500 recruiter and career coach", "Your item_career_advice_related is your first impression with an employer, so it better be a good one. Recruiters are trained to scan your item_career_advice_related in a matter of seconds looking for ",
            ...
            "There is a lot of advice on how to improve your item_career_advice_related and some of it is really great and useful (and some of it is really not). In today’s competitive job market, ",
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity(), RecyclerView.HORIZONTAL, false));
         ...
         private void initviews(View view){
            ...
            AdapterCareerAdviceCategoryRelated adapterCareerAdviceCategoryView=new AdapterCareerAdviceCategoryRelated(getActivity(),list,1);
